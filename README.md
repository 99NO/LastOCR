...
6. 하단 로그에서 각 마침표의 parent line, center, normalizedV, ABOVE/BELOW/UNCERTAIN 판정을 확인합니다.
...
- 기본 threshold는 `normalizedV < 0.42`면 ABOVE, `normalizedV > 0.58`면 BELOW, 그 사이는 UNCERTAIN입니다.
